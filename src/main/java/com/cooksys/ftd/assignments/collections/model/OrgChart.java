...
public class OrgChart {
    ...
    public boolean addEmployee(Employee employee) {
        //Try if statements with the return

        boolean flag;
        if (employee == null) {
            flag = false;
        } else if (orgChart.contains(employee)) {
            flag = false;
        ...
        //Why do I get a compile error if I delete the below return statement  ??
        return flag;
    }
    ...
    public Set<Employee> getDirectSubordinates(Manager manager) {
        ...
        if (!orgChart.contains(manager)) {
            ...
            for (Employee e : allEmployees) {
                //I was not completing all the test cases when I did this below
    ...
    public Map<Manager, Set<Employee>> getFullHierarchy() {
        ...
        for (Manager e : allManagers) {
            if (hasEmployee((Employee) e)) {
                if (getDirectSubordinates(e) != null) {
                    fullHierarchy.put(e, getDirectSubordinates(e));
                } else {
                    break;
                }
            } else {
